...
import logoimg08 from '../assets/img/page/logo/logo08.png';
...
import mainimg08 from '../assets/img/page/screen/mainimg08.jpg';
...
export const skillText = [
	{
		title: 'Listening',
		desc: '저는 상대방의 이야기를 귀 기울여 듣는 것을 좋아하고, 그 이야기에 진심을 담아 공감하는 성격입니다! 이러한 성격 덕분에 관계에서 신뢰를 쌓고, 협업에서도 긍정적인 에너지를 전할 수 있습니다.🫡',
		chaImg: chaImg01,
	},
	{
		title: 'Less but better',
		desc: "항상 '부족하지만 더 나아질 수 있다'는 마음가짐으로 프로젝트에 임합니다.  스스로의 부족함을 인정하는 것이 성장의 시작이라고 생각하며, 그 과정을 통해 매번 새로운 도전을 즐기고 최선을 다해 프로젝트를 완성해나가고자 합니다.😌",
		chaImg: chaImg02,
	},
	{
		title: 'Choice Without Regret',
		desc: '후회 없는 선택과 삶을 살고 싶기에 매 순간 신중하고 열심히 살아가려고 노력합니다. 하지만 때로는 후회할 선택을 하더라도, 그 선택에서 배우고자 직접 부딪혀보며 성장해나가는 것이 중요하다고 생각합니다. 실패조차도 하나의 경험이자 교훈으로 삼아, 앞으로 더 나은 길을 만들어가고자 합니다.😊',
		chaImg: chaImg03,
	},
	{
		title: 'Communication',
		desc: '저는 원활한 소통이 팀원들과의 협업에서 가장 중요한 요소라고 믿습니다. 효과적인 소통을 통해 팀 내 신뢰를 쌓고, 각자의 역할이 잘 조화되어 효율적인 협업이 이루어질 수 있습니다. 저는 소통을 통해 팀의 목표를 함께 이루어나가고, 긍정적인 팀 문화를 만드는 데 기여하고자 합니다.',
		chaImg: chaImg04,
	},
	{
		title: 'Passion',
		desc: '항상 밝은 에너지로 동료들과 적극적으로 소통하고 협력하며, 함께 최고의 결과를 만들어내는 것을 즐깁니다. 매력적인 코딩과 깔끔한 동적 구현을 통해 팀의 목표를 달성하고, 신뢰받는 퍼블리셔/프론트엔드 개발자가 되겠습니다.',
		chaImg: chaImg05,
	},
	{
		title: 'Effort',
		desc: '저는 항상 신입의 마음가짐을 잃지 않고, 열정과 도전정신을 품고 있습니다. 새로운 일을 시작할 때마다 두려움보다 호기심이 앞서며, 모든 과정을 즐기려고 노력합니다. 이러한 태도를 바탕으로 최선을 다한다면, 그 결과는 반드시 빛을 발할 것이라고 확신합니다. 저는 과거의 경험을 통해 배운 것들을 활용하여 더욱 성장하고, 매 순간 최선을 다하며 새로운 도전을 즐길 것입니다.💫',
		chaImg: chaImg06,
	},
	{
		title: 'Steadily',
		desc: '웹디자인을 하면서 자연스럽게 웹에 대한 호기심이 생겼고, 그 호기심이 지금까지 저를 이끌어왔습니다. 현재도 웹에 대한 즐거움 속에서 배우고 있으며, 비록 속도는 느릴 수 있지만 꾸준히 성장하고 있다고 느낍니다.🤓',
		chaImg: chaImg07,
	},
];
...
export const siteText = [
	...
	},
	{
		...
		text: [''],
		view: 'https://wedding-invitation.chang-ju.shin-hee.com/',
...
export const proText = [
	...
	// >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> 전통문화혁신플랫폼
	{
		...
		text: [
			...
			{
				texttitle: 'AAA',
				textdesc: 'site compliant with',
			},
			{
				texttitle: 'AAA',
				textdesc: 'html, css, jquery, and javascript',
			},
		],
		logoimg: logoimg02,
		logoalt: '전통문화혁신플랫폼',
	...
	// >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> 제보
	{
		id: 4,
		num: '02',
		period: '2023.02 - 2023.05, 2024.08~',
		...
		text: [
			...
			},
			{
				texttitle: 'AAA',
				textdesc:
					'제보큐브(구 제보 더보기)는 사용자가 커뮤니티, 채널, 테마, 캠페인 피드에 참여할 수 있는 공간으로, 이를 보다 직관적이고 사용하기 쉽게 만들기 위해 UI/UX 개선 디자인과 개발을 수행하였습니다. 사용자 경험을 최적화하고, 시각적으로 매력적인 인터페이스를 제공하여 사용자 참여를 촉진할 수 있도록 하였습니다.',
			},
		],
		logoimg: logoimg04,
		logoalt: '제보',
	...
	// >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> 주식회사리스트
	{
		...
		text: [
			...
			{
				texttitle: 'AAA',
				textdesc: 'DBeaver 툴을 사용하여 입사자 및 퇴사자의 데이터 관리 업무를 수행하였습니다.',
			},
		],
		logoimg: logoimg05,
		logoalt: '(주)리스트',
	...
	// >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> 수집관리시스템
	{
		...
		text: [
			{
				texttitle: 'AAA',
				textdesc: '시스템의 사용자 인터페이스(UI)를 구성하는 화면 마크업과 CSS 스타일링을 담당하였습니다.',
			},
			{
				texttitle: '팝업 기능 구현',
				textdesc:
	...
	// >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> 메스와이저
	{
		...
		link: 'https://meswiser.ai/',
		title: '메스와이저',
		desc: 'GPT 기반의 인공지능 솔루션입니다. 메스와이저는 거대언어모델(LLM)인 GPT에 사용자가 추가 학습시킨 전문지식을 바탕으로, AI엔진이 사용자가 원하는 응답 결과를 빠르고 정확하게 제공하도록 설계된 플랫폼입니다.',
		text: [
			{
				texttitle: '사용자 인터페이스(UI)를 구성하는 화면 마크업과 CSS 스타일을 적용하였습니다.',
				textdesc: '시스템의 사용자 인터페이스(UI)를 구성하는 화면 마크업과 CSS 스타일링을 담당하였습니다.',
			},
			{
				texttitle: 'AAA',
...
export const contactText = [
	...
	{
		link: 'mailto:TLSGML656@gmail.com',
		title: 'mail : tlsgml656@gmail.com',
	},
];
